...
<body >
   ...
   <!-- /input-group -->
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/student/index.php" ><i class="fa fa-group fa-fw"></i>  Trainee </a>
                   ...
                   <!--      <li>
                      ...
                      <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') {  ?>
                      <li>
                             <a href="<?php echo web_root; ?>admin/instructor/index.php" ><i class="fa fa-users fa-fw"></i> Manage Trainer  </a>
                    ...
                    <!--     <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                     <a href="<?php echo web_root; ?>admin/subject/index.php"><i class="fa fa-circle-o fa-fw"></i> Topic </a>
                                </li> 
                                <li>
